...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 120, ; uint32_t number_of_assemblies_in_apk (0x78)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 544, ; uint32_t number_of_dso_cache_entries (0x220)
	i32 33555157, ; uint32_t android_runtime_jnienv_class_token (0x20002d5)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [544 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.87_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-Mono.Android.Export.dll.so
		ptr null; void* handle (0x0)
	}, ; 9
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 651756377, ; hash 0x26d90359, from name: aot-MiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-System.Diagnostics.DiagnosticSource.dll.so
		ptr null; void* handle (0x0)
	}, ; 128
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1175938887, ; hash 0x46176747, from name: MiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	...
	%struct.DSOCacheEntry {
		i64 1665505923, ; hash 0x63459a83, from name: libaot-MiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 194
	...
	%struct.DSOCacheEntry {
		i64 1904686879, ; hash 0x7187371f, from name: aot-MiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 2286524306, ; hash 0x88499792, from name: MiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 285
	...
	%struct.DSOCacheEntry {
		i64 2831200674, ; hash 0xa8c0b1a2, from name: libaot-MiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 357
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [120 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"1cf57f98-4d86-40bb-8da7-815d8a270f96\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.companyname.miapp\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [20 x i8] c"libaot-MiApp.dll.so\00", align 1
...
@.DSOCacheEntry.27_name = private unnamed_addr constant [50 x i8] c"libaot-System.Diagnostics.DiagnosticSource.dll.so\00", align 1
...
@.DSOCacheEntry.87_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 1
@.DSOCacheEntry.88_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 1
@.DSOCacheEntry.89_name = private unnamed_addr constant [34 x i8] c"libaot-Mono.Android.Export.dll.so\00", align 1
